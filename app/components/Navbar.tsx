                    ...
                    <div className="p-8">
                      ...
                      <div className="mt-8 pt-6 border-t border-gray-100">
                        <div className="flex justify-between items-center">
                          ...
                          <Link href="/contact" className="bg-black hover:bg-gray-800 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                            Contact Sales
                          </Link>
                        </div>
                      </div>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <div className="pt-4 mt-4 border-t border-gray-200 px-3 space-y-3">
                <Link href="/login" className="w-full text-center border border-gray-300 text-gray-700 hover:border-black hover:text-black px-4 py-2 text-sm font-medium rounded-lg transition-colors block">
                  Log in
                </Link>
                <Link href="/register" className="w-full text-center bg-black hover:bg-gray-800 text-white px-4 py-2 text-sm font-medium rounded-lg transition-colors block">
                  Sign Up
                </Link>
              </div>
            </div>
